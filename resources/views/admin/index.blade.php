  ...
  <aside class="sidebar-wrapper">
        ...
        <ul class="metismenu" id="sidenav">
          <li>
            ...
            <ul>
              ...
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Alternate</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Data</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Advance</a>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Basic</a>
              </li>       
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Advance</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Contacts</a>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Add Product</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Products</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Customers</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Customer Details</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Orders</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Order Details</a>
              </li>
            </ul>     
          </li>
          <li>
            ...
            <ul>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Alerts</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Accordions</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Badges</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Buttons</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Carousels</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Media
                  Objects</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Modals</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Navs & Tabs</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Navbar</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Pagination</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Popovers
                  & Tooltips</a>    
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Progress</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Spinners</a>
              </li>
              <li><a href="#"><i
                    class="material-icons-outlined">arrow_right</i>Notifications</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Avatrs &
                  Chips</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Typography</a>
               </li>
               <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Utilities</a>
               </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Line Icons</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Boxicons</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Feather
                  Icons</a>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Form Elements</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Input Groups</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Radios &
                  Checkboxes</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Forms Layouts</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Form Validation</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Form Wizard</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>File Upload</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Date
                  Pickers</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Select2</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Form Repeater</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Basic Table</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Data Table</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Calendar</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>To do</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Invoice</a>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li><a class="has-arrow" href="javascript:;"><i class="material-icons-outlined">arrow_right</i>Basic</a>
                <ul>
                  <li><a href="#" target="_blank"><i class="material-icons-outlined">arrow_right</i>Login</a></li>
                  <li><a href="#" target="_blank"><i class="material-icons-outlined">arrow_right</i>Register</a></li>
                  <li><a href="#" target="_blank"><i class="material-icons-outlined">arrow_right</i>Forgot Password</a></li>
                  <li><a href="#" target="_blank"><i class="material-icons-outlined">arrow_right</i>Reset Password</a></li>
                </ul>
              </li>
          ...
          <li>
            ...
            <ul>
              <li><a href="#" target="_blank"><i class="material-icons-outlined">arrow_right</i>404
                  Error</a>
              </li>
              <li><a href="#" target="_blank"><i class="material-icons-outlined">arrow_right</i>505
                  Error</a>
              </li>
          ...
          <li>
            ...
            <ul>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Apex</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Chartjs</a>
              </li>   
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Google Maps</a>
              </li>
              <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Vector Maps</a>
              </li>
            </ul>
          </li>
              ...
              <li><a class="has-arrow" href="javascript:;"><i class="material-icons-outlined">arrow_right</i>Level
                ...
                <ul>
                  <li><a class="has-arrow" href="javascript:;"><i class="material-icons-outlined">arrow_right</i>Level
                      Two</a>
                    <ul>
                      <li><a href="#"><i class="material-icons-outlined">arrow_right</i>Level Three</a>
                      </li>
                    </ul>
                  </li>
                </ul>
    ...
    <div class="sidebar-bottom gap-4">
        ...
        <div class="dropdown dropup-center dropup dropdown-laungauge">
          <a class="dropdown-toggle dropdown-toggle-nocaret footer-icon" href="avascript:;" data-bs-toggle="dropdown"><img src="{{ asset('admin/assets/images/county/02.png') }}" width="22" alt="">
          </a>
                ...
                <div class="d-flex align-items-start justify-content-between mb-3">
                  ...
                  <div class="d-flex flex-column gap-4">
                     <div class="d-flex align-items-center gap-4">
                       <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                        <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                          <img src="{{ asset('admin/assets/images/projects/angular.png') }} " width="30" alt="">
                        </div>
                          <div class="">
                     ...
                     <div class="d-flex align-items-center gap-4">
                      <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                       <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                         <img src="{{ asset('admin/assets/images/projects/react.png') }} " width="30" alt="">
                       </div>
                         <div class="">
                    ...
                    <div class="d-flex align-items-center gap-4">
                      <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                       <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                         <img src="{{ asset('admin/assets/images/projects/vue.png') }} " width="30" alt="">
                       </div>
                         <div class="">
                    ...
                    <div class="d-flex align-items-center gap-4">
                      <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                       <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                         <img src="{{ asset('admin/assets/images/projects/bootstrap.png') }} " width="30" alt="">
                       </div>
                         <div class="">
                    ...
                    <div class="d-flex align-items-center gap-4">
                      <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                       <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                         <img src="{{ asset('admin/assets/images/projects/magento.png') }} " width="30" alt="">
                       </div>
                         <div class="">
                    ...
                    <div class="d-flex align-items-center gap-4">
                      <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                       <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                         <img src="{{ asset('admin/assets/images/projects/django.png') }} " width="30" alt="">
                       </div>
                         <div class="">
                    ...
                    <div class="d-flex align-items-center gap-4">
                      <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                       <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                         <img src="{{ asset('admin/assets/images/projects/python.png') }} " width="30" alt="">
                       </div>
                         <div class="">
                ...
                <div class="d-flex flex-column justify-content-between gap-4">
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{ asset('admin/assets/images/apps/17.png') }} " width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{ asset('admin/assets/images/apps/18.png') }} " width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{ asset('admin/assets/images/apps/19.png') }} " width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{ asset('admin/assets/images/apps/20.png') }} " width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{ asset('admin/assets/images/apps/05.png') }} " width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{ asset('admin/assets/images/apps/08.png') }} " width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{ asset('admin/assets/images/apps/07.png') }} " width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="{{ asset('admin/assets/images/apps/12.png') }} " width="32" alt="">
         ...
         <div class="col-12 col-xl-12 d-flex">
          <div class="card w-100 rounded-4">
            <div class="card-body">
              ...
              <div class="d-flex flex-column gap-4">
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('admin/assets/images/orders/01.png') }} " width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('admin/assets/images/orders/08.png') }} " width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('admin/assets/images/orders/03.png') }} " width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('admin/assets/images/orders/04.png') }} " width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('admin/assets/images/orders/05.png') }} " width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('admin/assets/images/orders/06.png') }} " width="75" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="{{ asset('admin/assets/images/orders/07.png') }} " width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
