<header class="top-header">
    <nav class="navbar navbar-expand align-items-center gap-4">
      ...
      <ul class="navbar-nav gap-1 nav-right-links align-items-center">
                  ...
                  <div class="card rounded-4 shadow-none border mb-0">
                    <div class="card-body">
                      <div class="d-flex align-items-start gap-3">
                        ...
                        <img src="{{ asset('admin/assets/images/megaIcons/06.png') }}" width="40" alt="">
        ...
        <li class="nav-item dropdown">
          <a href="#" class="dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown">
             <img src="{{ asset('admin/assets/images/avatars/01.png') }}" class="rounded-circle p-1 border" width="45" height="45">
          </a>
